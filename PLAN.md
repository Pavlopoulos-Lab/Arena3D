...
- [x] **Canvas mouse/keyboard scene controls** (`clickDown/Drag/Up`, `sceneZoom`, `keyPressed`) — landed in `canvas_controls.ts` (see Phase 11 list). Right-click menu still open (`right_click_menu.ts`).
