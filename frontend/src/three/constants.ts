// Static geometry + color constants for the Three.js object model.
// Ported from v2 www/js/config/global_variables.js (the `const` block).
// Config-driven / mutable values live in runtime.ts, not here.

export const NODE_LABEL_DEFAULT_SIZE = '12px'

// Node geometry
export const SPHERE_RADIUS = 8
export const SPHERE_WIDTHSEGMENTS = 8
export const SPHERE_HEIGHTSEGMENTS = 8
export const BOX_SIZE = 12
export const DIAMOND_RADIUS = 10
export const CONE_RADIUS = 8
export const CONE_HEIGHT = 15

// Layer plane geometry
...
export const SELECTED_DEFAULT_COLOR = '#A3FF00'

// Categorical node/layer color palette (280 colors). Verbatim from v2.
export const COLOR_VECTOR_280: readonly string[] = [
  '#e41a1c',
  '#377eb8',
  '#4daf4a',
  '#984ea3',
