// Help panel — port of v2 views/help.R. Static HTML fragment + inner tab switching.

const HELP_HTML = `
<div id="helpDiv">
<div class="tab">
  <button class="tablinks" data-help-tab="Examples_tab">Examples</button>
  <button class="tablinks" data-help-tab="API_tab">API</button>
  <button class="tablinks" data-help-tab="Cytoscape_tab">Cytoscape App</button>
  <button class="tablinks" data-help-tab="File_tab">Input & Output Files</button>
  <button class="tablinks" data-help-tab="Navigation_tab">Navigation Controls</button>
  <button class="tablinks" data-help-tab="Layouts_tab">Layer Selection & Layouts</button>
  <button class="tablinks" data-help-tab="Scene_tab">Scene Actions</button>
  <button class="tablinks" data-help-tab="Layer_tab">Layer Actions</button>
  <button class="tablinks" data-help-tab="Node_tab">Node Actions</button>
  <button class="tablinks" data-help-tab="Edge_tab">Edge Actions</button>
  <button class="tablinks" data-help-tab="FPS_tab">FPS</button>
  <button class="tablinks" data-help-tab="About_tab">About</button>
</div>
  ...
  <pre class="last_p">
{
  ...
  "layers": [
    { "name": "Complex", "position_x": "-819.2", "position_y": "300", "position_z": "0",
      "last_layer_scale": "0.6", "rotation_x": "0", "rotation_y": "0", "rotation_z": "0",
      "floor_current_color": "#5e5a5a", "geometry_parameters_width": "1244.7619047619" },
    { "name": "Proteins", "position_x": "-159.6", "position_y": "850", "position_z": "0",
      "last_layer_scale": "1", "rotation_x": "0", "rotation_y": "0", "rotation_z": "0",
      "floor_current_color": "#5e5a5a", "geometry_parameters_width": "1244.7619047619" }
  ],
  "nodes": [
    { "name": "Pericentrin-GCP Complex", "layer": "Complex", "position_x": "0",
      "position_y": "-187.632917471854", "position_z": "212.593778709733",
      "scale": "0.53921568627451", "color": "#63b598", "url": "", "descr": "" },
    { "name": "TUBGCP2", "layer": "Proteins", "position_x": "0",
      "position_y": "-354.817961725556", "position_z": "347.86115539628",
      "scale": "0.57843137254902", "color": "#ce7d78", "url": "", "descr": "" }
  ],
  "edges": [
    { "src": "Pericentrin-GCP Complex_Complex", "trg": "TUBGCP2_Proteins",
      "opacity": "0.1", "color": "#CFCFCF", "channel": "" }
  ],
...
<div id="API_tab" class="tabcontent">
  ...
  <pre>
{
    "scene": { "position_x": "0", "position_y": "0", "scale": "0.6561", "color": "#000000",
        "rotation_x": "0.261799387799149", "rotation_y": "0.261799387799149", "rotation_z": "0.0872664625997165" },
    "layers": [
        { "name": "1", "position_x": "-480", "position_y": "0", "position_z": "0", "last_layer_scale": "1",
            "rotation_x": "0", "rotation_y": "0", "rotation_z": "0", "floor_current_color": "#777777",
            "geometry_parameters_width": "947" },
        { "name": "2", "position_x": "480", "position_y": "0", "position_z": "0", "last_layer_scale": "1",
            "rotation_x": "0", "rotation_y": "0", "rotation_z": "0", "floor_current_color": "#777777",
            "geometry_parameters_width": "947" }
    ],
    "nodes": [
        { "name": "A", "layer": "1", "position_x": "0", "position_y": "-410.179206860405",
            "position_z": "87.2109740224067", "scale": "1", "color": "#e41a1c", "url": "", "descr": "" },
        { "name": "B", "layer": "1", "position_x": "0", "position_y": "244.693623604753",
            "position_z": "-203.550830988035", "scale": "1", "color": "#e41a1c", "url": "", "descr": "" },
        { "name": "C", "layer": "2", "position_x": "0", "position_y": "-10.2895227857923",
            "position_z": "361.274295019168", "scale": "1", "color": "#377eb8", "url": "", "descr": "" }
    ],
    "edges": [
        { "src": "A_1", "trg": "B_1", "opacity": "1", "color": "#CFCFCF", "channel": "" },
        { "src": "A_1", "trg": "C_2", "opacity": "1", "color": "#CFCFCF", "channel": "" }
    ],
    "universalLabelColor": "#FFFFFF",
    "direction": false,
...
<div id="Layouts_tab" class="tabcontent">
  ...
  <p>
    ...
    <span class="numbering"> 3. </span> A list of available layout algorithms of the igraph package, to apply on
      selected layers (<span class="numbering">2</span>) based on the execution mode of (<span class="numbering">1</span>). <br />
    <span class="numbering"> 4. </span> A list of available clustering algorithms of the igraph package, to apply on
      selected layers (<span class="numbering">2</span>) based on the execution mode of (<span class="numbering">1</span>).
      <br />
...
function openHelpTab(
  ...
  const target = pane.querySelector<HTMLElement>(`#${tabName}`)
  if (target) target.style.display = 'inline-block'
  btn.classList.add('active')
}

export function initHelpPanel(): void {
  const pane = document.getElementById('panel-help')
  if (!pane) return
  pane.innerHTML = HELP_HTML
  const buttons = pane.querySelectorAll<HTMLElement>('.tablinks')
  buttons.forEach((btn) => {
    btn.addEventListener('click', () => {
      const tabName = btn.dataset.helpTab
      if (tabName) openHelpTab(pane, tabName, btn)
    })
  })
  // v2 default: open the Examples tab.
  const first = buttons[0]
  if (first?.dataset.helpTab) openHelpTab(pane, first.dataset.helpTab, first)
}
