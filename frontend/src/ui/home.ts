...
<div class="row panel-body">
  <div class="col-md-4">
    <img src="/images/help/mainview2.png" alt="Main View" class="img-fluid m-1" />
  </div>
  <div class="col-md-8">
    <p>
      ...
      Arena3D<sup>web</sup> supports weighted and unweighted undirected graphs.
      <br /><br />
      &#8594; To start using Arena3D<sup>web</sup> click on the <b>File</b> menu tab and upload a network.
      <br /><br />
      &#8594; Visit the <a href="#" id="link_to_examples">Help/Examples page</a> to download some Arena3D<sup>web</sup> example files.
      <br /><br />
      &#8594; Get started by uploading your networks <a href="#" id="link_to_fileInput">here.</a>
    </p>
    <p>
      Please acknowledge the use of Arena3D<sup>web</sup> by citing the following publications:<br /><br />
      ...
      <b>doi:</b> <a href="https://doi.org/10.1093/nargab/lqad053" target="_blank">https://doi.org/10.1093/nargab/lqad053</a>;
      ...
      <b>doi:</b> <a href="https://doi.org/10.1093/nar/gkab278" target="_blank">https://doi.org/10.1093/nar/gkab278</a>;
